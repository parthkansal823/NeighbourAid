...
export default {
  ...
  nav_safety: 'Safety',
  nav_help: 'Help',
  help_title: 'Neighbourhood help',
  help_subtitle: 'Paid help from people nearby — an electrician, a plumber, someone to look at a laptop.',
  help_all: 'All',
  help_post: 'Ask for help',
  help_cancel: 'Cancel',
  help_offer: 'Offer to help',
  help_offers: 'offers',
  help_accept: 'Accept',
  help_accepted: 'Offer accepted',
  help_mark_done: 'Mark done',
  help_withdraw: 'Withdraw',
  help_withdraw_confirm: 'Withdraw this request? Anyone who offered will be told.',
  help_withdrawn: 'Request withdrawn',
  help_withdrawn_notified: 'Withdrawn — the people who offered have been told',
  help_cancelled_note: 'The person who asked has withdrawn this job.',
  help_status_open: 'Open',
  help_status_accepted: 'Accepted',
  help_status_done: 'Done',
  help_status_cancelled: 'Cancelled',
  help_empty: 'Nothing nearby yet',
  help_empty_body: 'Nobody in your area has asked for help. Post the first request.',
  help_load_error: 'Could not load requests',
  help_kind: 'What kind of help',
  help_what: 'What do you need',
  help_what_ph: 'Fuse box trips when the geyser runs',
  help_details: 'Details (optional)',
  help_budget: 'Your budget',
  help_budget_min: 'Minimum budget',
  help_budget_max: 'Maximum budget',
  help_budget_hint: 'Leave blank to ask people to quote their own price.',
  help_contact: 'How to reach you',
  help_contact_ph: 'Phone or WhatsApp',
  help_contact_hint: 'Shown only to you, and to the person whose offer you accept.',
  help_post_submit: 'Post request',
  help_posted: 'Request posted',
  help_need_location: 'Location needed to post',
  help_your_offer: 'Your offer',
  help_your_price: 'Your price',
  help_when: 'When can you come',
  help_when_ph: 'Today around 6pm',
  help_send_offer: 'Send offer',
  help_offer_sent: 'Offer sent',
  nav_news: 'News',
  ...
  news_title: 'Crisis news',
  news_subtitle: 'Indian news feeds, scored for how much to trust them.',
  news_refresh: 'Refresh news',
  news_error: 'Could not load news',
  news_empty: 'No news right now',
  news_empty_body: 'The feeds are quiet. Pull to refresh in a few minutes.',
  ...
  post_voice_tip_start: 'Speak instead of typing. Works in Chrome/Edge',
  post_voice_privacy: 'Your browser sends the audio to its speech service (Google, in Chrome) to transcribe it.',
  post_voice_privacy_anon: 'You are reporting anonymously — but a recording of your voice can identify you. Type instead if that matters.',
