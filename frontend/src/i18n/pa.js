...
export default {
  ...
  nav_safety: 'ਸੁਰੱਖਿਆ',
  nav_help: 'ਮਦਦ',
  help_title: 'ਗੁਆਂਢ ਦੀ ਮਦਦ',
  help_subtitle: 'ਨੇੜਲੇ ਲੋਕਾਂ ਤੋਂ ਪੇਡ ਮਦਦ — ਇਲੈਕਟ੍ਰੀਸ਼ੀਅਨ, ਪਲੰਬਰ, ਲੈਪਟਾਪ ਦੇਖਣ ਵਾਲਾ।',
  help_all: 'ਸਭ',
  help_post: 'ਮਦਦ ਮੰਗੋ',
  help_cancel: 'ਰੱਦ ਕਰੋ',
  help_offer: 'ਮਦਦ ਦੀ ਪੇਸ਼ਕਸ਼',
  help_offers: 'ਪੇਸ਼ਕਸ਼ਾਂ',
  help_accept: 'ਸਵੀਕਾਰ ਕਰੋ',
  help_accepted: 'ਪੇਸ਼ਕਸ਼ ਸਵੀਕਾਰ ਹੋਈ',
  help_mark_done: 'ਮੁਕੰਮਲ',
  help_withdraw: 'ਵਾਪਸ ਲਓ',
  help_withdraw_confirm: 'ਇਹ ਬੇਨਤੀ ਵਾਪਸ ਲੈਣੀ ਹੈ? ਜਿਨ੍ਹਾਂ ਨੇ ਪੇਸ਼ਕਸ਼ ਦਿੱਤੀ ਹੈ ਉਨ੍ਹਾਂ ਨੂੰ ਦੱਸਿਆ ਜਾਵੇਗਾ।',
  help_withdrawn: 'ਬੇਨਤੀ ਵਾਪਸ ਲਈ ਗਈ',
  help_withdrawn_notified: 'ਵਾਪਸ ਲਈ ਗਈ — ਪੇਸ਼ਕਸ਼ ਦੇਣ ਵਾਲਿਆਂ ਨੂੰ ਦੱਸ ਦਿੱਤਾ ਗਿਆ ਹੈ',
  help_cancelled_note: 'ਜਿਸ ਨੇ ਮੰਗਿਆ ਸੀ ਉਸ ਨੇ ਇਹ ਕੰਮ ਵਾਪਸ ਲੈ ਲਿਆ ਹੈ।',
  help_status_open: 'ਖੁੱਲ੍ਹੀ',
  help_status_accepted: 'ਸਵੀਕਾਰ',
  help_status_done: 'ਪੂਰਾ',
  help_status_cancelled: 'ਰੱਦ',
  help_empty: 'ਨੇੜੇ ਅਜੇ ਕੁਝ ਨਹੀਂ',
  help_empty_body: 'ਤੁਹਾਡੇ ਇਲਾਕੇ ਵਿੱਚ ਕਿਸੇ ਨੇ ਮਦਦ ਨਹੀਂ ਮੰਗੀ। ਪਹਿਲੀ ਬੇਨਤੀ ਪਾਓ।',
  help_load_error: 'ਬੇਨਤੀਆਂ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੀਆਂ',
  help_kind: 'ਕਿਸ ਤਰ੍ਹਾਂ ਦੀ ਮਦਦ',
  help_what: 'ਤੁਹਾਨੂੰ ਕੀ ਚਾਹੀਦਾ',
  help_what_ph: 'ਗੀਜ਼ਰ ਚੱਲਣ ਤੇ ਫਿਊਜ਼ ਬਾਕਸ ਟ੍ਰਿਪ ਕਰਦਾ ਹੈ',
  help_details: 'ਵੇਰਵੇ (ਵਿਕਲਪਿਕ)',
  help_budget: 'ਤੁਹਾਡਾ ਬਜਟ',
  help_budget_min: 'ਘੱਟੋ-ਘੱਟ ਬਜਟ',
  help_budget_max: 'ਵੱਧ ਤੋਂ ਵੱਧ ਬਜਟ',
  help_budget_hint: 'ਖਾਲੀ ਛੱਡੋ ਤਾਂ ਲੋਕ ਆਪਣੀ ਕੀਮਤ ਦੱਸਣਗੇ।',
  help_contact: 'ਤੁਹਾਡੇ ਨਾਲ ਕਿਵੇਂ ਸੰਪਰਕ ਕਰੀਏ',
  help_contact_ph: 'ਫ਼ੋਨ ਜਾਂ WhatsApp',
  help_contact_hint: 'ਸਿਰਫ਼ ਤੁਹਾਨੂੰ, ਅਤੇ ਜਿਸਦੀ ਪੇਸ਼ਕਸ਼ ਸਵੀਕਾਰ ਕਰੋ ਉਸਨੂੰ ਦਿਖਦਾ ਹੈ।',
  help_post_submit: 'ਬੇਨਤੀ ਪਾਓ',
  help_posted: 'ਬੇਨਤੀ ਪਾ ਦਿੱਤੀ',
  help_need_location: 'ਪਾਉਣ ਲਈ ਟਿਕਾਣਾ ਚਾਹੀਦਾ',
  help_your_offer: 'ਤੁਹਾਡੀ ਪੇਸ਼ਕਸ਼',
  help_your_price: 'ਤੁਹਾਡੀ ਕੀਮਤ',
  help_when: 'ਕਦੋਂ ਆ ਸਕਦੇ ਹੋ',
  help_when_ph: 'ਅੱਜ ਸ਼ਾਮ 6 ਵਜੇ',
  help_send_offer: 'ਪੇਸ਼ਕਸ਼ ਭੇਜੋ',
  help_offer_sent: 'ਪੇਸ਼ਕਸ਼ ਭੇਜੀ',
  nav_news: 'ਖ਼ਬਰਾਂ',
  nav_resources: 'ਸਰੋਤ',
  nav_logout: 'ਲੌਗਆਉਟ',
  ...
  home_subtitle:
    'NeighbourAid ਸੰਕਟ ਵਿੱਚ ਫਸੇ ਲੋਕਾਂ ਨੂੰ ਨੇੜਲੇ ਵਲੰਟੀਅਰਾਂ ਨਾਲ ਸਿੱਧਾ ਜੋੜਦਾ ਹੈ। ਤੁਰੰਤ ਟ੍ਰਾਇਆਜ, ਲਾਈਵ ਨਕਸ਼ੇ ਅਤੇ ਤੁਰੰਤ ਸੂਚਨਾਵਾਂ — ਸਭ ਮੁਫ਼ਤ, ਸਭ ਸਥਾਨਕ।',
  ...
  news_title: 'ਸੰਕਟ ਖ਼ਬਰਾਂ',
  news_subtitle: 'ਭਾਰਤੀ ਖ਼ਬਰ ਫੀਡ, ਭਰੋਸੇਯੋਗਤਾ ਦੇ ਅੰਕਾਂ ਨਾਲ।',
  news_refresh: 'ਖ਼ਬਰਾਂ ਤਾਜ਼ਾ ਕਰੋ',
  news_error: 'ਖ਼ਬਰਾਂ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੀਆਂ',
  news_empty: 'ਹੁਣ ਕੋਈ ਖ਼ਬਰ ਨਹੀਂ',
  news_empty_body: 'ਫੀਡ ਸ਼ਾਂਤ ਹਨ। ਕੁਝ ਮਿੰਟਾਂ ਵਿੱਚ ਦੁਬਾਰਾ ਦੇਖੋ।',
  ...
  post_subtitle:
    'ਤੁਹਾਡੀ ਰਿਪੋਰਟ ਜ਼ਰੂਰਤ ਮੁਤਾਬਕ ਵੰਡੀ ਜਾਵੇਗੀ ਅਤੇ ਨੇੜਲੇ ਵਲੰਟੀਅਰਾਂ ਨੂੰ ਤੁਰੰਤ ਸੂਚਨਾ ਮਿਲੇਗੀ।',
  post_category: 'ਸ਼੍ਰੇਣੀ',
  post_description: 'ਵੇਰਵਾ',
  post_description_hint:
    '(ਇਸੇ ਤੋਂ ਜ਼ਰੂਰਤ ਤੈਅ ਹੁੰਦੀ ਹੈ)',
  ...
  post_voice_tip_start: 'ਟਾਈਪ ਕਰਨ ਦੀ ਬਜਾਏ ਬੋਲੋ। Chrome/Edge ਵਿੱਚ ਚੱਲਦਾ ਹੈ',
  post_voice_privacy: 'ਆਵਾਜ਼ ਨੂੰ ਲਿਖਤ ਵਿੱਚ ਬਦਲਣ ਲਈ ਤੁਹਾਡਾ ਬ੍ਰਾਊਜ਼ਰ ਆਡੀਓ ਆਪਣੀ ਸਪੀਚ ਸੇਵਾ (Chrome ਵਿੱਚ Google) ਨੂੰ ਭੇਜਦਾ ਹੈ।',
  post_voice_privacy_anon: 'ਤੁਸੀਂ ਗੁਮਨਾਮ ਰਿਪੋਰਟ ਕਰ ਰਹੇ ਹੋ — ਪਰ ਤੁਹਾਡੀ ਆਵਾਜ਼ ਤੁਹਾਡੀ ਪਛਾਣ ਕਰਾ ਸਕਦੀ ਹੈ। ਲੋੜ ਹੋਵੇ ਤਾਂ ਟਾਈਪ ਕਰੋ।',
