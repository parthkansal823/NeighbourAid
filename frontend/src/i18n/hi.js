...
export default {
  ...
  nav_safety: 'सुरक्षा',
  nav_help: 'मदद',
  help_title: 'पड़ोस की मदद',
  help_subtitle: 'आस-पास के लोगों से पेड मदद — इलेक्ट्रीशियन, प्लंबर, या लैपटॉप देखने वाला।',
  help_all: 'सभी',
  help_post: 'मदद माँगें',
  help_cancel: 'रद्द करें',
  help_offer: 'मदद की पेशकश',
  help_offers: 'पेशकश',
  help_accept: 'स्वीकारें',
  help_accepted: 'पेशकश स्वीकार की गई',
  help_mark_done: 'पूरा हुआ',
  help_withdraw: 'वापस लें',
  help_withdraw_confirm: 'यह अनुरोध वापस लें? जिन लोगों ने ऑफ़र दिया है उन्हें बता दिया जाएगा।',
  help_withdrawn: 'अनुरोध वापस ले लिया गया',
  help_withdrawn_notified: 'वापस लिया गया — ऑफ़र देने वालों को बता दिया गया है',
  help_cancelled_note: 'मांगने वाले ने यह काम वापस ले लिया है।',
  help_status_open: 'खुला',
  help_status_accepted: 'स्वीकृत',
  help_status_done: 'पूरा',
  help_status_cancelled: 'रद्द',
  help_empty: 'आस-पास कुछ नहीं',
  help_empty_body: 'आपके इलाके में किसी ने मदद नहीं माँगी। पहली रिक्वेस्ट डालें।',
  help_load_error: 'रिक्वेस्ट लोड नहीं हो सकीं',
  help_kind: 'किस तरह की मदद',
  help_what: 'आपको क्या चाहिए',
  help_what_ph: 'गीज़र चलने पर फ़्यूज़ बॉक्स ट्रिप करता है',
  help_details: 'विवरण (वैकल्पिक)',
  help_budget: 'आपका बजट',
  help_budget_min: 'न्यूनतम बजट',
  help_budget_max: 'अधिकतम बजट',
  help_budget_hint: 'खाली छोड़ें तो लोग अपना दाम बताएँगे।',
  help_contact: 'आपसे कैसे संपर्क करें',
  help_contact_ph: 'फ़ोन या WhatsApp',
  help_contact_hint: 'सिर्फ़ आपको, और जिसकी पेशकश आप स्वीकारें उसे दिखेगा।',
  help_post_submit: 'रिक्वेस्ट डालें',
  help_posted: 'रिक्वेस्ट डाल दी',
  help_need_location: 'डालने के लिए लोकेशन चाहिए',
  help_your_offer: 'आपकी पेशकश',
  help_your_price: 'आपका दाम',
  help_when: 'कब आ सकते हैं',
  help_when_ph: 'आज शाम 6 बजे',
  help_send_offer: 'पेशकश भेजें',
  help_offer_sent: 'पेशकश भेज दी',
  nav_news: 'समाचार',
  ...
  home_subtitle:
    'NeighbourAid संकट में फँसे लोगों को पास के स्वयंसेवकों से रियल टाइम में जोड़ता है। तुरंत ट्रायाज, लाइव नक्शे और तुरंत सूचनाएँ — सब मुफ़्त, सब स्थानीय।',
  ...
  news_title: 'संकट समाचार',
  news_subtitle: 'भारतीय समाचार फ़ीड, विश्वसनीयता के अंक के साथ।',
  news_refresh: 'समाचार ताज़ा करें',
  news_error: 'समाचार लोड नहीं हो सके',
  news_empty: 'अभी कोई समाचार नहीं',
  news_empty_body: 'फ़ीड शांत हैं। कुछ मिनटों में फिर देखें।',
  ...
  post_subtitle:
    'आपकी रिपोर्ट तात्कालिकता के हिसाब से छाँटी जाएगी और पास के स्वयंसेवकों को तुरंत सूचना मिलेगी।',
  post_category: 'श्रेणी',
  post_description: 'विवरण',
  post_description_hint:
    '(इसी से तात्कालिकता तय होती है)',
  ...
  post_voice_tip_start: 'टाइप करने के बजाय बोलें। Chrome/Edge में चलता है',
  post_voice_privacy: 'बोली को टेक्स्ट में बदलने के लिए आपका ब्राउज़र ऑडियो अपनी स्पीच सेवा (Chrome में Google) को भेजता है।',
  post_voice_privacy_anon: 'आप गुमनाम रिपोर्ट कर रहे हैं — लेकिन आपकी आवाज़ से आपकी पहचान हो सकती है। ज़रूरी हो तो टाइप करें।',
